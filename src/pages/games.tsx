...
const projects = [
  {
    ...
    tags: ['Bughouse 2300+', 'Bullet 2000+', 'Blitz 1900+'],
    link: 'https://www.chess.com/profile/sayaori',
    live: 'https://www.chess.com/profile/sayaori',
  },
  {
    title: 'Zetamac',
  ...
  },
  {
    ...
    tags: ['Social Deduction', 'Bullet', 'Blitz'],
